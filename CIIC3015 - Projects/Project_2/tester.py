...
# CIIC3015 - Projects/Project_2/SantiagoMichael_070L_p2.py
...
if __name__ == "__main__":
    ...
    for image in os.listdir(IMAGE_DIR):
        name = os.path.join(
            IMAGE_DIR, image
        )  # get the full path from current directory
        try:
        ...
        for newim, func in modified:
            ...
            save_as_image_file(
                newim, os.path.join(RESULT_DIR, newname)
            )  # saves image to result directory
